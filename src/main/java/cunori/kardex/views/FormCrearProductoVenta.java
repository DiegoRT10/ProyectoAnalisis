...
public class FormCrearProductoVenta extends javax.swing.JDialog {
    ...
    public FormCrearProductoVenta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//    p.setStock(Integer.parseInt(txtStock.getText())); aqui va ir la resta de la cantidad por el stock
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCrearProductoVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormCrearProductoVenta dialog = new FormCrearProductoVenta(new javax.swing.JFrame(), true);
